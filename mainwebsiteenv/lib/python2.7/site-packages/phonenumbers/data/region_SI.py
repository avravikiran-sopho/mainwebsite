...
PHONE_METADATA_SI = PhoneMetadata(id='SI', country_code=386, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:[37][01]\\d|4[0139]\\d|51\\d|6(?:[48]\\d|9[69]))\\d{5}', example_number='31234567', possible_length=(8,)),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[12]|[34][24-8]|5[2-8]|7[3-8]'], national_prefix_formatting_rule='(0\\1)'),
