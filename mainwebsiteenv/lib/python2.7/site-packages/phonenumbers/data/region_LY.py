...
PHONE_METADATA_LY = PhoneMetadata(id='LY', country_code=218, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[25679]\\d{8}', possible_length=(9,), possible_length_local_only=(7,)),
    ...
    number_format=[NumberFormat(pattern='([25-79]\\d)(\\d{7})', format='\\1-\\2', leading_digits_pattern=['[25-79]'], national_prefix_formatting_rule='0\\1')])
