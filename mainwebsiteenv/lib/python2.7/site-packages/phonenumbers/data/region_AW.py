...
PHONE_METADATA_AW = PhoneMetadata(id='AW', country_code=297, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[25-9]\\d{6}', possible_length=(7,)),
    ...
    voip=PhoneNumberDesc(national_number_pattern='28\\d{5}|501\\d{4}', example_number='5011234', possible_length=(7,)),
