...
PHONE_METADATA_NA = PhoneMetadata(id='NA', country_code=264, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:60|8[125])\\d{7}', example_number='811234567', possible_length=(9,)),
    premium_rate=PhoneNumberDesc(national_number_pattern='8701\\d{5}', example_number='870123456', possible_length=(9,)),
    voip=PhoneNumberDesc(national_number_pattern='8(?:3\\d{2}|86)\\d{5}', example_number='88612345', possible_length=(8, 9)),
    national_prefix='0',
    national_prefix_for_parsing='0',
    number_format=[NumberFormat(pattern='(8\\d)(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['8[1-35]'], national_prefix_formatting_rule='0\\1'),
