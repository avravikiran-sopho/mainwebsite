...
PHONE_METADATA_BY = PhoneMetadata(id='BY', country_code=375, international_prefix='810',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-4]\\d{8}|8(?:0(?:0\\d{3,7}|[13]\\d{7})|(?:10|20\\d)\\d{7})|9\\d{9,10}', possible_length=(6, 7, 8, 9, 10, 11), possible_length_local_only=(5, 6, 7)),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1(?:5(?:1[1-5]|[24]\\d|6[2-4]|9[1-7])|6(?:[235]\\d|4[1-7])|7\\d{2})|2(?:1(?:[246]\\d|3[0-35-9]|5[1-9])|2(?:[235]\\d|4[0-8])|3(?:[26]\\d|3[02-79]|4[024-7]|5[03-7])))\\d{5}', example_number='152450911', possible_length=(9,), possible_length_local_only=(5, 6, 7)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:2(?:5[5679]|9[1-9])|33\\d|44\\d)\\d{6}', example_number='294911911', possible_length=(9,)),
    toll_free=PhoneNumberDesc(national_number_pattern='8(?:0[13]|20\\d)\\d{7}|800\\d{3,7}', example_number='8011234567', possible_length=(6, 7, 8, 9, 10, 11)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='8(?:0[13]|10|20\\d)\\d{7}|800\\d{3,7}|902\\d{7}', example_number='82012345678', possible_length=(6, 7, 8, 9, 10, 11)),
