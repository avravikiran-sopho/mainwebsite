...
PHONE_METADATA_IN = PhoneMetadata(id='IN', country_code=91, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d{8})', format='\\1', leading_digits_pattern=['561', '5616', '56161'], national_prefix_formatting_rule='\\1', national_prefix_optional_when_formatting=True),
        ...
        NumberFormat(pattern='(\\d{4})(\\d{2})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['160', '1600'], national_prefix_formatting_rule='\\1', national_prefix_optional_when_formatting=True),
        NumberFormat(pattern='(\\d{4})(\\d{4,5})', format='\\1 \\2', leading_digits_pattern=['180', '1800'], national_prefix_formatting_rule='\\1', national_prefix_optional_when_formatting=True),
