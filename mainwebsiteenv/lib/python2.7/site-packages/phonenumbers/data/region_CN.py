...
PHONE_METADATA_CN = PhoneMetadata(id='CN', country_code=86, international_prefix='(1(?:[129]\\d{3}|79\\d{2}))?00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='21(?:100\\d{2}|95\\d{3,4}|\\d{8,10})|(?:10|2[02-57-9]|3(?:11|7[179])|4(?:[15]1|3[1-35])|5(?:1\\d|2[37]|3[12]|51|7[13-79]|9[15])|7(?:31|5[457]|6[09]|91)|8(?:[57]1|98))(?:100\\d{2}|95\\d{3,4}|\\d{8})|(?:3(?:1[02-9]|35|49|5\\d|7[02-68]|9[1-68])|4(?:1[02-9]|2[179]|3[3-9]|5[2-9]|6[4789]|7\\d|8[23])|5(?:3[03-9]|4[36]|5[02-9]|6[1-46]|7[028]|80|9[2-46-9])|6(?:3[1-5]|6[0238]|9[12])|7(?:01|[17]\\d|2[248]|3[04-9]|4[3-6]|5[0-4689]|6[2368]|9[02-9])|8(?:078|1[236-8]|2[5-7]|3\\d|5[1-9]|7[02-9]|8[3678]|9[1-7])|9(?:0[1-3689]|1[1-79]|[379]\\d|4[13]|5[1-5]))(?:100\\d{2}|95\\d{3,4}|\\d{7})|80(?:29|6[03578]|7[018]|81)\\d{4}', example_number='1012345678', possible_length=(7, 8, 9, 10, 11, 12), possible_length_local_only=(5, 6)),
    mobile=PhoneNumberDesc(national_number_pattern='1(?:[38]\\d{3}|4[57]\\d{2}|5[0-35-9]\\d{2}|66\\d{2}|7(?:[0-35-8]\\d{2}|40[0-5])|99\\d{2})\\d{6}', example_number='13123456789', possible_length=(11,)),
    ...
    number_format=[NumberFormat(pattern='(80\\d{2})(\\d{4})', format='\\1 \\2', leading_digits_pattern=['80[26-8]'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True, domestic_carrier_code_formatting_rule='$CC \\1'),
    ...
    intl_number_format=[NumberFormat(pattern='(80\\d{2})(\\d{4})', format='\\1 \\2', leading_digits_pattern=['80[26-8]']),
        NumberFormat(pattern='([48]00)(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['[48]00']),
