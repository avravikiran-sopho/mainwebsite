...
PHONE_METADATA_TR = PhoneMetadata(id='TR', country_code=90, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-589]\\d{9}|444\\d{4}', possible_length=(7, 10)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='5(?:(?:0[1-7]|22|[34]\\d|5[1-59]|9[246])\\d{2}|6161)\\d{5}', example_number='5012345678', possible_length=(10,)),
