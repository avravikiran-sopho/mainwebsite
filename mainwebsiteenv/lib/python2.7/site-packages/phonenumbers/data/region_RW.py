...
PHONE_METADATA_RW = PhoneMetadata(id='RW', country_code=250, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[027-9]\\d{7,8}', possible_length=(8, 9)),
    fixed_line=PhoneNumberDesc(national_number_pattern='2[258]\\d{7}|06\\d{6}', example_number='250123456', possible_length=(8, 9)),
    mobile=PhoneNumberDesc(national_number_pattern='7[238]\\d{7}', example_number='720123456', possible_length=(9,)),
    ...
    number_format=[NumberFormat(pattern='(2\\d{2})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['2']),
