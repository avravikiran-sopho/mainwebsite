...
PHONE_METADATA_LU = PhoneMetadata(id='LU', country_code=352, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2[2-9]\\d{2,9}|(?:3(?:[0-46-9]\\d|5[013-9])|[457]\\d{2}|8(?:0[2-9]|[13-9]\\d)|9(?:0[89]|[2-579]\\d))\\d{1,8})', example_number='27123456', possible_length=(4, 5, 6, 7, 8, 9, 10, 11)),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{3})', format='\\1 \\2', leading_digits_pattern=['[2-5]|7[1-9]|[89](?:0[2-9]|[1-9])'], domestic_carrier_code_formatting_rule='$CC \\1'),
        NumberFormat(pattern='(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3', leading_digits_pattern=['[2-5]|7[1-9]|[89](?:0[2-9]|[1-9])'], domestic_carrier_code_formatting_rule='$CC \\1'),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{2})(\\d{2})(\\d{1,4})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['2(?:[12589]|4[12])|[3-5]|7[1-9]|8(?:0[2-9]|[1-9])|9(?:0[2-46-9]|[1-9])'], domestic_carrier_code_formatting_rule='$CC \\1'),
