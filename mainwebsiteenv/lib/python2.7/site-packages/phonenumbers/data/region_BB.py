...
PHONE_METADATA_BB = PhoneMetadata(id='BB', country_code=1, international_prefix='011',
    ...
    premium_rate=PhoneNumberDesc(national_number_pattern='900\\d{7}|246976\\d{4}', example_number='9002123456', possible_length=(10,), possible_length_local_only=(7,)),
    ...
    uan=PhoneNumberDesc(national_number_pattern='246(?:292|367|4(?:1[7-9]|3[01]|44|67)|736)\\d{4}', example_number='2464301234', possible_length=(10,), possible_length_local_only=(7,)),
    national_prefix='1',
