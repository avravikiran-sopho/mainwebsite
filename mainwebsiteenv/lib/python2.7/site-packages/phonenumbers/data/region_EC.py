...
PHONE_METADATA_EC = PhoneMetadata(id='EC', country_code=593, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='9(?:(?:39|[45][89]|7[7-9]|[89]\\d)\\d{2}|6(?:[017-9]\\d{2}|2(?:[0-47-9]\\d|5[1-9]|60)|30\\d))\\d{4}', example_number='991234567', possible_length=(9,)),
