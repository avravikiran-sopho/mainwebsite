...
PHONE_METADATA_GW = PhoneMetadata(id='GW', country_code=245, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:4(?:0\\d{5}|4\\d{7})|9\\d{8})', possible_length=(7, 9)),
    fixed_line=PhoneNumberDesc(national_number_pattern='443\\d{6}', example_number='443201234', possible_length=(9,)),
    mobile=PhoneNumberDesc(national_number_pattern='9(?:5(?:5\\d|6[0-2])|6(?:5[0-2]|6\\d|9[012])|77\\d)\\d{5}', example_number='955012345', possible_length=(9,)),
    voip=PhoneNumberDesc(national_number_pattern='40\\d{5}', example_number='4012345', possible_length=(7,)),
    number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['44|9[5-7]']),
