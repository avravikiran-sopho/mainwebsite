...
PHONE_METADATA_AU = PhoneMetadata(id='AU', country_code=None, international_prefix=None,
    ...
    short_code=PhoneNumberDesc(national_number_pattern='000|1(?:06|1(?:00|2|9[46])|2(?:[23]\\d|4\\d{2,3}|5\\d{3,4}|8(?:2|[013-9]\\d))|555|9[13-5]\\d{3})|225|7(?:33|67)', example_number='112', possible_length=(3, 4, 5, 6, 7, 8)),
